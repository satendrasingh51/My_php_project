...
{
 $sql_query="SELECT * FROM registration WHERE id=".$_GET['view_id'];
    ...
    <table class="table col-md-12">
      ...
      <div class="list-group col-md-6 text-right">
       ...
       <div class="list-group col-md-6 text-left">
        <ul class="list-group">
            <input type="text" name="id" value="<?php echo $fetched_row['id'] ?>">
            <input type="text" name="id" value="<?php echo $fetched_row['username'] ?>">
